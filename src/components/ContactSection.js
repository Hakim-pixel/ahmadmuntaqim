    ...
    >
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-16 items-start">
        ...
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-text-primary mb-4 tracking-tight">
          ...
          <div className="flex flex-col gap-4 text-sm">
            {[
              ...
              <div key={c.label} className="flex items-center gap-4">
                <span className="text-xs font-mono text-text-muted w-16 shrink-0">{c.label}</span>
                <a
                  href={c.href}
                  target="_blank"
                  rel="noreferrer"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label htmlFor="c-name" className="block text-xs text-text-muted font-mono mb-1.5">
                Nama
              </label>
              <input
                id="c-name"
            ...
            <div>
              <label htmlFor="c-email" className="block text-xs text-text-muted font-mono mb-1.5">
                Email
              </label>
              <input
                id="c-email"
          ...
          <div>
            <label htmlFor="c-msg" className="block text-xs text-text-muted font-mono mb-1.5">
              Pesan
            </label>
            <textarea
              id="c-msg"
          ...
          {/* Success message */}
          {status === 'success' && (
            <div className="flex items-center gap-2 text-sm text-green-400 bg-green-400/8 border border-green-400/20 rounded-lg px-4 py-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <p className="text-xs text-text-muted">
              ...
              <a href="https://wa.me/6289516409902" target="_blank" rel="noreferrer"
                className="text-accent-dim hover:text-text-primary transition-colors">
                WhatsApp
              </a>
            </p>
          </div>
